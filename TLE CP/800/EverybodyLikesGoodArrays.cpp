...
Approach: Insted of replaceing, we treat a[i+1] elem as the preoduct of the elems a[i] and a[i+1] (same parity elements).
*/
...
bool isSame(int a, int b){
    if(a%2 and b%2) return true;
    else if(!(a%2) and !(b%2)) return true;
    return false;
}
// Main function
int main() {
