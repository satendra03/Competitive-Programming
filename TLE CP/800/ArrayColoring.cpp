...
Approach: Sum of like parity is even, means if the sum is even, we can divide the array in even-even or odd-odd, ie same parity but in case of odd we can do that
*/
